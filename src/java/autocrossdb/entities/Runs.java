...
@NamedQueries({
    ...
    @NamedQuery(name = "Runs.findTopConeKiller", query = "SELECT r.runDriverName, sum(r.runCones) FROM Runs r where r.runEventUrl.eventUrl = :eventUrl GROUP BY r.runDriverName ORDER BY sum(r.runCones) desc"),
